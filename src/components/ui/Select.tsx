...
// Added labelClassName and descriptionClassName to the interface
...
const Select = React.forwardRef<HTMLButtonElement, SelectProps>(({
    ...
    required = false,
    label,
    labelClassName,        // Destructured here
    description,
    descriptionClassName,  // Destructured here
    error,
    searchable = false,
    clearable = false,
    loading = false,
            ...
            {label && (
                <label
                    ...
                    className={cn(
                        ...
                        labelClassName // Apply the custom class here
                    )}
                >
                    {label}
